...
?>
        ...
        <!-- card -->
        <div class="col-3 mt-5 d-flex justify-content-center" style="box-shadow: 0 4px 8px , border 1px solid #ddd" >
            ...
            <a href="singleProductView.php?s=<?php echo $d["stock_id"] ?>"><img src="<?php echo $d["path"] ?>" class="card-img-top"/></a> 
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                      <a href="<?php echo"singleProductView.php?id=". $d["stock_id"];?>" class="col-6"><button class="btn btn-outline-primary "> Add To Cart</button></a>  
                      <a href="<?php echo"singleProductView.php?id=". $d["stock_id"];?>"><button class="btn btn-outline-warning col-12 ms-2"> Byu Now</button></a>   
                    </div>
                </div>
